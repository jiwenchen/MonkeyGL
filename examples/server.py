...
def show_annotation(
    ...
    hm = get_monkey_instance(uid)
    if show:
        hm.AddAnnotation(mk.PlaneVR, "Hello Monkey", 250, 150, mk.FontSizeSmall, mk.AnnotationFormatLeft, mk.RGBA(1.0, 0.0, 0.0))
        hm.AddAnnotation(mk.PlaneVR, "Hello Monkey", 250, 200, mk.FontSizeMiddle, mk.AnnotationFormatCenter, mk.RGBA(0.0, 1.0, 0.0))
        hm.AddAnnotation(mk.PlaneVR, "Hello Monkey", 250, 300, mk.FontSizeBig, mk.AnnotationFormatRight, mk.RGBA(1.0, 1.0, 1.0))
